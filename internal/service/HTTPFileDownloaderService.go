...
// HTTPFileDownloaderService is the FTP implementation of Downloader Service.
type HTTPFileDownloaderService struct {
...
func (service HTTPFileDownloaderService) Download(configID string) (filePath string, err error) {
